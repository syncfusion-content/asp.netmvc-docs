...
1. Create an MVC Project and add necessary assemblies, styles and scripts to it. Refer [MVC-Getting Started](/aspnetmvc/getting-started ).
...
1. Create a MVC Project and add necessary assemblies and scripts to it. 
   ...
   Refer [MVC-Getting Started](/aspnetmvc/getting-started ).
