...
<system.serviceModel>
    ...
    <services>
        <service name="PivotClientDemo.RelationalService">
            <endpoint address="" behaviorConfiguration="PivotClientDemo.RelationalServiceAspNetAjaxBehavior" binding="webHttpBinding" contract="PivotClientDemo.IRelationalService" />
        </service>
    </services>
</system.serviceModel>
