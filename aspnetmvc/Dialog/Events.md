---
layout: post
title: Events | Dialog | ASP.NET MVC | Syncfusion
description: events
platform: ejmvc
control: Dialog
documentation: ug
...
Dialog triggered Create and BeforeOpen event_               
{:.caption}
...
Dialog triggered Open and BeforeClose event  
{:.caption}
...
Dialog triggered Close and Drag event
{:.caption}
...
Dialog triggered DragStart and DragStop event
{:.caption}
...
Dialog triggered Resize and ResizeStart event
{:.caption}
...
Dialog triggered ResizeStop event
{:.caption}
