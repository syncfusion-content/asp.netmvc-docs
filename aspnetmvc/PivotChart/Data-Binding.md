---
layout: post
title: Data Binding | PivotChart | ASP.NET MVC | Syncfusion
...
To add a WCF service in an existing MVC Application, right-click on the project in Solution Explorer and select **Add > New Item**. In the **Add New Item** window, select WCF Service and name it as `PivotChartService.svc`, click **Add.**
...
public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(
                ...
                namespaces: new[] { "PivotChartDemo.Controllers" }
            );
        }
