...
@(Html.EJ().Schedule("Schedule1")
        ...
        .AppointmentSettings(fields => fields.Datasource(dataSrc => dataSrc.URL("http://services.odata.org/V4/Northwind/Northwind.svc/Orders/").Adaptor(AdaptorType.ODataV4Adaptor))
            .Id("Id")
            .Subject("ShipName")
            .StartTime("OrderDate")
...
@(Html.EJ().Schedule("Schedule1")
        ...
        .Height("525px")
        .CurrentDate(new DateTime(2015, 11, 5))
        .AppointmentSettings(fields => fields.Datasource(dataSrc => dataSrc.URL("Home/GetData").CrudURL("Home/Batch").Adaptor("UrlAdaptor"))
            .Id("Id")
            .Subject("Subject")
            .StartTime("StartTime")
            .EndTime("EndTime")
...
@(Html.EJ().Schedule("Schedule1")
        ...
        .Height("525px")
        .CurrentDate(new DateTime(2015, 11, 5))
        .AppointmentSettings(fields => fields.Datasource(dataSrc => dataSrc.URL("Home/GetData").BatchURL("Home/Crud").InsertURL("Home/add").UpdateURL("Home/update").RemoveURL("Home/remove").Adaptor(AdaptorType.UrlAdaptor))
            .Id("Id")
            .Subject("Subject")
            .StartTime("StartTime")
            .EndTime("EndTime")
...
@(Html.EJ().Schedule("Schedule1")
        ...
        .CurrentDate(new DateTime(2015, 11, 5))
        .EnableLoadOnDemand(true)
        .AppointmentSettings(fields => fields.Datasource(dataSrc => dataSrc.URL("http://mvc.syncfusion.com/OdataServices/api/ScheduleData/").CrossDomain(true))
            .Id("Id")
            .Subject("Subject")
            .StartTime("StartTime")
            .EndTime("EndTime")
