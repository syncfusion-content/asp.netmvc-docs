---
layout: post
title: Getting Started | PercentageTextBox | ASP.NET MVC | Syncfusion
description: Learn here more about getting started with Syncfusion Essential ASP.NET MVC PercentageTextBox Control, its elements, and more.
platform: ejmvc
control: PercentageTextBox
documentation: ug
---

# Getting Started with ASP.NET MVC PercentageTextBox
...
![Create your first PercentageTextBox in ASP.NET MVC](Getting-Started_images/Getting-Started_img1.png)
...
![Create Editors ASP.NET MVC PercentageTextBox](Getting-Started_images/Getting-Started_img2.png)
...
![Set MinValue, MaxValue and value in ASP.NET MVC PercentageTextBox](Getting-Started_images/Getting-Started_img3.png)
...
![Set Calculation process with ASP.NET MVC PercentageTextBox](Getting-Started_images/Getting-Started_img4.png)
