...
1. Create a MVC Project and add necessary Dll’s and Scripts. Refer [MVC-Getting Started](http://docs.syncfusion.com/aspnetmvc/percenttextboxes/getting-started).
