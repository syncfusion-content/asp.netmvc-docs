...
![](OLAP-Client-Elements_images/third level.png) <br/>
</td>
...
![](OLAP-Client-Elements_images/add element.png)
...
![](OLAP-Client-Elements_images/remove measure editor.png)
...
![](OLAP-Client-Elements_images/add new report.png)
...
![](OLAP-Client-Elements_images/add new report1.png)
...
![](OLAP-Client-Elements_images/removereport1.png)
...
The [PivotGrid](http://help.syncfusion.com/aspnetmvc/pivotgrid/overview) and [OlapChart](http://help.syncfusion.com/aspnetmvc/olapchart/overview) controls will be rendered with respect to the operations done at axis element builder.
