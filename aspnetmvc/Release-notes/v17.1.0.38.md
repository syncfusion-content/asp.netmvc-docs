...
* \#228625, \#228311 - Resolved the issue “shared data source name and its credentials not retrieved in the Report Viewer”.
* \#228634 - `ZoomFactor` with float values does not take any effect in the Report Viewer issue has been resolved.
## Spreadsheet
