...
* [Click here,](https://help.syncfusion.com/js/backward-compatibility) to know about the list of API's removed or modified in the vol-4 release.
## DatePicker
