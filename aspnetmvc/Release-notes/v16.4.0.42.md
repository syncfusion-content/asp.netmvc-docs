...
* Starting with version 16.4 (2018 Vol 4), Syncfusion has removed the fewer NuGet packages from the Essential Studio. You can find the older NuGet packages and their equivalent new NuGet package details from the [`KB`](https://support.syncfusion.com/kb/article/8331/syncfusion-nuget-packages-updates-not-available-for-latest-version) article.
## Chart
...
*  \#219099 - Grid Exporting works fine when multiple selection enabled on initial rendering.
## PDF
