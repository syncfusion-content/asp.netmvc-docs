...
* `MenuItem` property removed from `ContextMenuSettings.MenuItems`.User can give [`MenuItems`](https://help.syncfusion.com/api/js/ejkanban#members:contextmenusettings-menuitems) as string of array.
