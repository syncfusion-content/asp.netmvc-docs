...
<div id="license">
Starting with version 16.4 (2018 Vol 4), Syncfusion has removed the .NET Framework 3.5, 4.5.1 and MVC3 assemblies from ASP.NET MVC setup and providing the separate add on setup. 
