...
* Localization— EJ MVC NumericTextBox has localization support. It use ej.globalize.js file to globalize and localize the format, and parse numbers and dates according to the culture.
