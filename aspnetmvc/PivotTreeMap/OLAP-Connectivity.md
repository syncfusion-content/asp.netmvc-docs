...
Now the connection string to connect OLAP Cube, PivotTreeMap and JavaScriptSerializer instances are created immediately inside the main class in `PivotTreeMapService.svc.cs` file.
