     ...
     @(Html.EJ().TreeGrid("TreeGridContainer")
	   ...
	   .Columns(co =>
            ...
            .StackedHeaderRows(row => {
                row.StackedHeaderColumns(stackcol =>
                {
                    stackcol.HeaderText("Shipment Details").Column(col =>
                    {
                        col.Add("ID");
                        col.Add("Name");
                        col.Add("Category");
                    ...
                    stackcol.HeaderText("Price Details").Column(col =>
                    {
                        col.Add("UnitPrice");
                        col.Add("Price");
                    }).Add();
...
{% highlight CSHTML %}
     @(Html.EJ().TreeGrid("TreeGridContainer")
            ...
            .StackedHeaderRows(row => {
                row.StackedHeaderColumns(stackcol =>
                {
                    stackcol.TextAlign(TextAlign.Right).HeaderText("Shipment Details").Column(col =>
                    {
                        col.Add("ID");
                        col.Add("Name");
                        col.Add("Category");
                    ...
                    stackcol.TextAlign(TextAlign.Left).HeaderText("Price Details").Column(col =>
                    {
                        col.Add("UnitPrice");
                        col.Add("Price");
                    }).Add();
