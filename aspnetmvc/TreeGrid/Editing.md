...
![Add new record in ASP.NET MVC TreGrid](Editing_images/addnewRowBefore.png)

The above screenshot shows before add a new record in TreeGrid.
{:.caption}

![Before Add new record in ASP.NET MVC TreGrid](Editing_images/addnewRowAfter.png)
...
![Add row possition in ASP.NET MVC TreGrid](Editing_images/addnewRowChild.png)
...
![Cell Editing in ASP.NET MVC TreGrid](Editing_images/cellEditing.png)
...
![Row Editting in ASP.NET MVC TreGrid](Editing_images/rowEditing.png)
...
![Dialog Editing in ASP.NET MVC TreGrid](Editing_images/dialogEditing.png)
...
![Batch Editting in ASP.NET MVC TreGrid](Editing_images/BatchEdit_img1.png)
...
![Output Batch Editting in ASP.NET MVC TreGrid](Editing_images/BatchEdit_img2.png)
...
![Edit types in ASP.NET MVC TreGrid](Editing_images/editType.png)
...
![Dropdown Edit in in ASP.NET MVC TreGrid](Editing_images/dropdownEdit.png)
...
![Dialog template in ASP.NET MVC TreGrid](Editing_images/dialogTemplate.png)
...
![Cell Edit Template in ASP.NET MVC TreGrid](Editing_images/editTemplate.png)
...
![Delete Record in ASP.NET MVC TreGrid](Editing_images/beforeDelete.png)

The above screenshot shows before delete a record in TreeGrid.
{:.caption}

![Before Delete Record in ASP.NET MVC TreGrid](Editing_images/afterDelete.png)
...
![Delete Confirmation Message in ASP.NET MVC TreGrid](Editing_images/deleteConfirmation.png)
