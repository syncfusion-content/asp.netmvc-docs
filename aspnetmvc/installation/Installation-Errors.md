...
* [Unable to install due to controlled folder access](http://help.syncfusion.com/aspnetmvc/installation/installation-errors#unable-to-install-due-to-controlled-folder-access)
