...
1. First create an MVC Project and add necessary Dll's and scripts with the help of the given [MVC-Getting Started](https://help.syncfusion.com/aspnetmvc/digitalgauge/getting-started) Documentation.
