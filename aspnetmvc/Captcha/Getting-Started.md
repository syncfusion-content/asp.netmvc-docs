...
description: Learn here more about getting started with Syncfusion Essential ASP.NET MVC Captcha Control, its elements, and more.
platform: ejmvc
control: Captcha
documentation: ug
---
...
![Output in ASP.NET MVC Captcha](Getting-Started_images/Getting-Started_img2.png)
...
![Enable Audio and Refresh in ASP.NET MVC Captcha](Getting-Started_images/Getting-Started_img3.png)
...
![Code Example in ASP.NET MVC Captcha](Getting-Started_images/Getting-Started_img4.png)

Captcha control with failed Auto Validation
{:.caption}

![Auto Validation in ASP.NET MVC Captcha](Getting-Started_images/Getting-Started_img5.png)
