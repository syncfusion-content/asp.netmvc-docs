...
> Before use the Syncfusion Troubleshooter for ASP.NET MVC (Essential JS 1), check whether the Syncfusion **Syncfusion Essential JS1 AspNet MVC VSExtensions** Extension installed or not in Visual Studio Extension Manager by clicking on the Tools -> Extensions and Updates -> Installed for Visual Studio 2017 or lower and for Visual Studio 2019 by clicking on the Extensions -> Manage Extensions -> Installed.
