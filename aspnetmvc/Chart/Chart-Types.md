...
@(Html.EJ().Chart("chartContainer")
     ...
     .Series(sr =>
     {
         ...
         sr.Type(SeriesType.StackingSplineArea)
            //...
             .Add();
     })
...
[Click](http://mvc.syncfusion.com/demos/web/chart/stackingarea) here to view Stacked Spline Area Chart online demo.
...
@(Html.EJ().Chart("chartContainer")
     ...
     {
         //Change type 
         sr.Type(SeriesType.StackingSplineArea100)
            //...
             .Add();
     })
...
[Click](http://mvc.syncfusion.com/demos/web/chart/stackingarea) here to view 100 % Stacked Spline Area Chart online demo.
...
@(Html.EJ().Chart("chartContainer")
     ...
     .Series(sr =>
     {
         ...
         sr.Type(SeriesType.Spline).SplineType(SplineType.Natural)
            //...
             .Add();
     })
...
@(Html.EJ().Chart("chartContainer")
     ...
     .Series(sr =>
     {
         ...
         sr.Type(SeriesType.Spline).SplineType(SplineType.Cardinal).CardinalSplineTension(0.7)
            //...
             .Add();
     })
...
[Click](http://mvc.syncfusion.com/demos/web/chart/spline) here to view the spline types chart online demo sample.
