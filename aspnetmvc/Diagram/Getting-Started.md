...
### Initialize Diagram
1\. Create an ASP.NET MVC application. You can refer [MVC Getting Started documentation](https://help.syncfusion.com/aspnetmvc/getting-started) to create a new project and to add necessary assemblies and script files.
