...
1. You can create an MVC Project and add necessary assembly and script with the help of the given [MVC-Getting Started](http://help.syncfusion.com/aspnetmvc/toolbar/getting-started) Documentation.
