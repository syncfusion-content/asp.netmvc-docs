...
To modify Grid appearance, you need to override default CSS of Grid. Please find the list of CSS classes and its corresponding section in Grid. Also you have an option to create your own custom theme for all ASP.NET MVC controls using our [Theme Studio](http://js.syncfusion.com/themestudio/# "Theme Studio").
  ...
  <table>
        ...
        <tr>
            ...
            <td>
                This class is added to row cell's of grid. this is override selection.
            </td>
        </tr>
        <tr>
